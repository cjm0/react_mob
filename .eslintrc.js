module.exports = {
  ...
  "parser": "@typescript-eslint/parser", // 将 ts 转换成与 estree 兼容的形式，以便在 eslint 中使用
  "parserOptions": {
    "ecmaFeatures": {
      "jsx": true // 启用 JSX
    },
  ...
  "plugins": [
    "react", // eslint-plugin-react 缩写，校验 react
    "react-hooks", // eslint-plugin-react-hooks 缩写，校验 hooks
    "@typescript-eslint" // @typescript-eslint/eslint-plugin 缩写
  ],
  // 可以全局使用变量
  "globals": {
    "Babel": true,
  ...
  "rules": {
    ...
    'no-unused-vars': 1, // 不要定义未使用的变量
    'no-empty': 1, // 不能有空行
    'no-restricted-globals': 0, // 禁止某些全局变量
    'no-use-before-define': 0, // 不必在使用前定义函数
    'react/prop-types': 0,
    'prefer-regex-literals': 0, // 正则表达式
    'quote-props': 0, // 属性禁止加引号
    ...
    'no-alert': process.env.NODE_ENV === 'production' ? 2 : 1, // alert
    'no-console': 0, // 提示 console
